...
{
    /// <summary>
    /// Holds the per-client HMAC credentials loaded once from configuration at application startup.
    /// Lookups are served entirely from memory; there are no per-request lookups.
    ...
    public sealed class InMemoryClientHmacCredentialRegistry : IClientHmacCredentialRegistry
    {
        ...
        /// <summary>
        /// Replaces the in-memory client set. Called once during startup after the configuration load completes.
        /// </summary>
